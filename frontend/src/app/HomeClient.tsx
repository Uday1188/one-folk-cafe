...
export default function Home() {
  ...
  const products: Product[] = fetchedProducts ? fetchedProducts.map((p: any) => ({
    ...
    price: p.price,
    image: p.image || p.imageUrl || "https://images.unsplash.com/photo-1541167760496-1628856ab772?q=80&w=600&auto=format&fit=crop",
    images: p.images || (p.image ? [p.image] : (p.imageUrl ? [p.imageUrl] : ["https://images.unsplash.com/photo-1541167760496-1628856ab772?q=80&w=600&auto=format&fit=crop"])),
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20">
          <div className="max-w-3xl">
            ...
            >
              ...
              <h1 className="sr-only">One Folk Cafe - Cafe and Coffee Shop in Nashik</h1>
              <h2 className="text-[42px] sm:text-7xl lg:text-8xl font-black text-white leading-[1.06] tracking-tight mb-6 sm:mb-8" style={{ fontFamily: 'var(--font-display)' }}>
                Where Every<br />
